...
def test_data_validation(data):
    ...
    try:
        ...
        # 验证基本字段
        fields = ['timestamp', 'speed', 'rpm', 'gear', 'fuel', 
        ...
        print(f"  轮胎压力 (PSI): {data.tire_pressure_fl:.1f} / {data.tire_pressure_fr:.1f} / {data.tire_pressure_rl:.1f} / {data.tire_pressure_rr:.1f}")
